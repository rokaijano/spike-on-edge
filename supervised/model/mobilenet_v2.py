...
def MobileNetV2(input_shape=None,
  ...
  x = _inverted_res_block(
      x, filters=24, alpha=alpha, stride=2, expansion=6, block_id=1) # out: 32x32x8

  x = _inverted_res_block(
      x, filters=24, alpha=alpha, stride=1, expansion=6, block_id=2)

  x = _inverted_res_block(
      x, filters=32, alpha=alpha, stride=2, expansion=6, block_id=3)  # out: 16x16x8
  ...
  #out1 = _inverted_res_block(
  #    x, filters=512, alpha=alpha, stride=1, expansion=6, block_id=222)

  #x = _inverted_res_block(
  #    x, filters=64, alpha=alpha, stride=2, expansion=6, block_id=6) # out: 8x8x
  x = _inverted_res_block(
  ...
  #x = _inverted_res_block(
  #    x, filters=160, alpha=alpha, stride=2, expansion=6, block_id=13) # out: 4x4x
  x = _inverted_res_block(
      x, filters=96, alpha=alpha, stride=1, expansion=6, block_id=14)
  x = _inverted_res_block(
      x, filters=96, alpha=alpha, stride=1, expansion=6, block_id=15)

  x = _inverted_res_block(
      x, filters=128, alpha=alpha, stride=1, expansion=6, block_id=16)
